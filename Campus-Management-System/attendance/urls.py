...
urlpatterns = [
    ...
    path("manage/vendors/", require_teacher(views.manage_vendors), name="manage_vendors"),
    path("manage/vendors/new/", require_teacher(views.manage_vendor_create), name="manage_vendor_create"),
    path("manage/vendors/<int:user_id>/delete/", require_teacher(views.manage_vendor_delete), name="manage_vendor_delete"),
    path("manage/food-stalls/", require_teacher(views.manage_food_stalls), name="manage_food_stalls"),
    path("manage/food-stalls/new/", require_teacher(views.manage_food_stall_create), name="manage_food_stall_create"),
    path("manage/food-stalls/<int:stall_id>/edit/", require_teacher(views.manage_food_stall_edit), name="manage_food_stall_edit"),
    path("manage/food-stalls/<int:stall_id>/delete/", require_teacher(views.manage_food_stall_delete), name="manage_food_stall_delete"),
    path("manage/menu-categories/", require_teacher(views.manage_menu_categories), name="manage_menu_categories"),
    path("manage/menu-categories/new/", require_teacher(views.manage_menu_category_create), name="manage_menu_category_create"),
    path("manage/menu-categories/<int:category_id>/edit/", require_teacher(views.manage_menu_category_edit), name="manage_menu_category_edit"),
    path("manage/menu-categories/<int:category_id>/delete/", require_teacher(views.manage_menu_category_delete), name="manage_menu_category_delete"),
    path("manage/menu-items/", require_teacher(views.manage_menu_items), name="manage_menu_items"),
    path("manage/menu-items/new/", require_teacher(views.manage_menu_item_create), name="manage_menu_item_create"),
    path("manage/menu-items/<int:item_id>/edit/", require_teacher(views.manage_menu_item_edit), name="manage_menu_item_edit"),
    path("manage/menu-items/<int:item_id>/delete/", require_teacher(views.manage_menu_item_delete), name="manage_menu_item_delete"),
